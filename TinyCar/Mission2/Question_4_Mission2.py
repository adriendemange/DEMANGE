        ...
        if prixht>20000 :
            ...
            if rep2=="O" :
                ...
                if carte==2 : # carte gold
                    ...
                    ttc=ttc -(ttc*(10/100))
                    print("Voici le TTC avec TVA à 5 pourcent car votre véhicule est électrique et la remise de 10 pourcent:\n", ttc)
            ...
            if rep2=="N" :
                if carte==3 : # carte platinium
                    ...
                    ttc=prixht*(0.2+1)*qte          #TVA de base à 0.2 pour le prix < 20 0000
                    ttc=ttc -(ttc*(15/100))
                    print("Voici le TTC avec TVA à 0.2 pourcent et la remise de 15 pourcent pour la carte platinium et véhicule non électrique:\n", ttc)
